...
// 颜色映射
const colorMap = {
  indigo: { light: "#818cf8", medium: "#6366f1", dark: "#4f46e5" },
  red: { light: "#f87171", medium: "#ef4444", dark: "#dc2626" },
  green: { light: "#4ade80", medium: "#22c55e", dark: "#16a34a" },
  blue: { light: "#60a5fa", medium: "#3b82f6", dark: "#2563eb" },
  yellow: { light: "#facc15", medium: "#eab308", dark: "#ca8a04" },
  purple: { light: "#c084fc", medium: "#a855f7", dark: "#9333ea" },
} as const;
