    ...
    >
      <div class="p-6 border-b border-gray-100">
        <div class="flex items-center justify-between">
          <h3 class="text-lg font-semibold text-gray-900">空间图片标签分析</h3>
          <div
            class="bg-fuchsia-50/70 rounded-full p-2 transition-colors duration-500"
          >
            <i class="i-tabler:tags text-fuchsia-500 size-5"></i>
          </div>
        </div>
      </div>
      ...
      <div class="relative p-6">
        ...
        >
          <div class="flex flex-col items-center gap-3">
            <div
              class="w-8 h-8 border-3 border-fuchsia-600 border-t-transparent rounded-full animate-spin"
            ></div>
