    ...
    >
      <div class="p-6 border-b border-gray-100">
        <div class="flex items-center justify-between">
          <h3 class="text-lg font-semibold text-gray-900">空间图片分类分析</h3>
          <div
            class="bg-blue-50/70 rounded-full p-2 transition-colors duration-500"
          >
            <i class="i-tabler:chart-pie text-blue-500 size-5"></i>
          </div>
        </div>
      </div>
