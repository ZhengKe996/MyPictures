...
public class FileManager {
    ...
    FileManager(CosManager cosManager, CosClientConfig cosClientConfig) {
     ...
     * @return 返回上传图片的结果信息
     * @throws BusinessException 当图片上传失败时抛出业务异常
     */
    ...
    /**
     * 验证图片文件的合法性
     * 此方法对图片文件的URL进行格式验证、协议检查、文件存在性验证、文件类型和文件大小的校验
     *
     * @param fileUrl 文件的URL地址
     * @throws BusinessException 当文件地址格式不正确、协议不支持、文件类型不允许多大时抛出
     */
